...
export default function Page() {
  ...
  return (<div>
    <div className='bg-gray-950 py-10'
      ...
      <Navbar />
      <div className="container lg:t-[100px] mx-auto py-10">
        ...
        <div className="mt-24 lg:ml-[100px] flex-col">
          ...
          <div className='bg-gray-500 rounded-s ml-4 lg:ml-0 w-[350px]  text-[15px] mt-[30px] border-white'><p className='ml-[3px]'>Here are six examples of our notable works:</p></div>
        </div>
    ...
    <div className="mt-10   grid grid-cols-1 lg:ml-[120px] ml-4 lg:grid-cols-2 gap-8"
       >
          {works.map((work) => (
            ...
            <div className='bg-gray-500 rounded-sm px-2 text-[15px] mt-[10px] border-white'><p className='ml-[3px]'>{work.link}</p></div>
            </div>
